...
//
/**
 *  getClustersNumber - SeeAlso ``getClustersNumber:``
 */
...
//
/**
 * - SeeAlso ``setCovarianceMatrixType:``
 */
...
//
/**
 *  getCovarianceMatrixType - SeeAlso ``getCovarianceMatrixType:``
 */
