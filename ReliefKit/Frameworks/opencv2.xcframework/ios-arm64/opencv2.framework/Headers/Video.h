 ...
 *
 * - SeeAlso ``findTransformECC:inputImage:warpMatrix:motionType:criteria:inputMask:gaussFiltSize:``
 */
 ...
 */
+ (double)findTransformECCWithMask:(Mat*)templateImage inputImage:(Mat*)inputImage templateMask:(Mat*)templateMask inputMask:(Mat*)inputMask warpMatrix:(Mat*)warpMatrix motionType:(int)motionType criteria:(TermCriteria*)criteria gaussFiltSize:(int)gaussFiltSize NS_SWIFT_NAME(findTransformECCWithMask(templateImage:inputImage:templateMask:inputMask:warpMatrix:motionType:criteria:gaussFiltSize:));
 ...
 * findTransformECC, computeECC, estimateAffine2D, estimateAffinePartial2D, findHomography
 */
+ (double)findTransformECCWithMask:(Mat*)templateImage inputImage:(Mat*)inputImage templateMask:(Mat*)templateMask inputMask:(Mat*)inputMask warpMatrix:(Mat*)warpMatrix motionType:(int)motionType criteria:(TermCriteria*)criteria NS_SWIFT_NAME(findTransformECCWithMask(templateImage:inputImage:templateMask:inputMask:warpMatrix:motionType:criteria:));
 ...
 * findTransformECC, computeECC, estimateAffine2D, estimateAffinePartial2D, findHomography
 */
+ (double)findTransformECCWithMask:(Mat*)templateImage inputImage:(Mat*)inputImage templateMask:(Mat*)templateMask inputMask:(Mat*)inputMask warpMatrix:(Mat*)warpMatrix motionType:(int)motionType NS_SWIFT_NAME(findTransformECCWithMask(templateImage:inputImage:templateMask:inputMask:warpMatrix:motionType:));
 ...
 * findTransformECC, computeECC, estimateAffine2D, estimateAffinePartial2D, findHomography
 */
+ (double)findTransformECCWithMask:(Mat*)templateImage inputImage:(Mat*)inputImage templateMask:(Mat*)templateMask inputMask:(Mat*)inputMask warpMatrix:(Mat*)warpMatrix NS_SWIFT_NAME(findTransformECCWithMask(templateImage:inputImage:templateMask:inputMask:warpMatrix:));


//
//  double cv::findTransformECCMultiScale(Mat reference, Mat sample, Mat& warpMatrix, ECCParameters eccParams = ECCParameters(), Mat referenceMask = Mat(), Mat sampleMask = Mat())
//
/**
 ...
 * computeECC, estimateAffine2D, estimateAffinePartial2D, findHomography
 */
+ (double)findTransformECCMultiScale:(Mat*)reference sample:(Mat*)sample warpMatrix:(Mat*)warpMatrix eccParams:(ECCParameters*)eccParams referenceMask:(Mat*)referenceMask sampleMask:(Mat*)sampleMask NS_SWIFT_NAME(findTransformECCMultiScale(reference:sample:warpMatrix:eccParams:referenceMask:sampleMask:));
 ...
 * computeECC, estimateAffine2D, estimateAffinePartial2D, findHomography
 */
+ (double)findTransformECCMultiScale:(Mat*)reference sample:(Mat*)sample warpMatrix:(Mat*)warpMatrix eccParams:(ECCParameters*)eccParams referenceMask:(Mat*)referenceMask NS_SWIFT_NAME(findTransformECCMultiScale(reference:sample:warpMatrix:eccParams:referenceMask:));
 ...
 * computeECC, estimateAffine2D, estimateAffinePartial2D, findHomography
 */
+ (double)findTransformECCMultiScale:(Mat*)reference sample:(Mat*)sample warpMatrix:(Mat*)warpMatrix eccParams:(ECCParameters*)eccParams NS_SWIFT_NAME(findTransformECCMultiScale(reference:sample:warpMatrix:eccParams:));
 ...
 * computeECC, estimateAffine2D, estimateAffinePartial2D, findHomography
 */
+ (double)findTransformECCMultiScale:(Mat*)reference sample:(Mat*)sample warpMatrix:(Mat*)warpMatrix NS_SWIFT_NAME(findTransformECCMultiScale(reference:sample:warpMatrix:));
