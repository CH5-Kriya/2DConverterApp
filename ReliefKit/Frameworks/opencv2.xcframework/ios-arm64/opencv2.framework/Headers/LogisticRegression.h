...
//
/**
 *  getLearningRate - SeeAlso ``getLearningRate:``
 */
...
//
/**
 *  getIterations - SeeAlso ``getIterations:``
 */
...
//
/**
 *  getRegularization - SeeAlso ``getRegularization:``
 */
...
//
/**
 *  getTrainMethod - SeeAlso ``getTrainMethod:``
 */
...
//
/**
 *  getMiniBatchSize - SeeAlso ``getMiniBatchSize:``
 */
