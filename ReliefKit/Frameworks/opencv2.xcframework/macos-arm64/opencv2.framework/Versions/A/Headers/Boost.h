...
//
/**
 *  getBoostType - SeeAlso ``getBoostType:``
 */
...
//
/**
 *  getWeakCount - SeeAlso ``getWeakCount:``
 */
...
//
/**
 *  getWeightTrimRate - SeeAlso ``getWeightTrimRate:``
 */
