 ...
 * - SeeAlso threshold, adaptiveThreshold
 */
 ...
 * @param numIters optional number of iterations used for filtering, 3 is quite enough.
 *
 * - SeeAlso bilateralFilter, ``guidedFilter:src:dst:radius:eps:dDepth:scale:``, ``amFilter:src:dst:sigma_s:sigma_r:adjust_outliers:``
 */
 ...
 * with almost no visible degradation. (e.g. scale==0.5 shrinks the image by 2x inside the filter)
 *
 * - SeeAlso bilateralFilter, ``dtFilter:src:dst:sigmaSpatial:sigmaColor:mode:numIters:``, ``amFilter:src:dst:sigma_s:sigma_r:adjust_outliers:``
 */
 ...
 * Note:* Joint images with CV_8U and CV_16U depth converted to images with CV_32F depth and [0; 1]
 * color range before processing. Hence color space sigma sigma_r must be in [0; 1] range, unlike same
 * sigmas in bilateralFilter and dtFilter functions. - SeeAlso bilateralFilter, ``dtFilter:src:dst:sigmaSpatial:sigmaColor:mode:numIters:``, ``guidedFilter:src:dst:radius:eps:dDepth:scale:``
 */
 ...
 *
 * - SeeAlso bilateralFilter, ``amFilter:src:dst:sigma_s:sigma_r:adjust_outliers:``
 */
 ...
 *
 * - SeeAlso ``rollingGuidanceFilter:dst:d:sigmaColor:sigmaSpace:numOfIter:borderType:``, bilateralFilter
 */
 ...
 *
 * - SeeAlso ``jointBilateralFilter:src:dst:d:sigmaColor:sigmaSpace:borderType:``, bilateralFilter, ``amFilter:src:dst:sigma_s:sigma_r:adjust_outliers:``
 */
 ...
 *
 * - SeeAlso medianBlur, ``jointBilateralFilter:src:dst:d:sigmaColor:sigmaSpace:borderType:``
 */
