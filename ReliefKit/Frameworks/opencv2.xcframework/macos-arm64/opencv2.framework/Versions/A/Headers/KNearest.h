...
//
/**
 *  getDefaultK - SeeAlso ``getDefaultK:``
 */
...
//
/**
 *  getIsClassifier - SeeAlso ``getIsClassifier:``
 */
...
//
/**
 *  getAlgorithmType - SeeAlso ``getAlgorithmType:``
 */
