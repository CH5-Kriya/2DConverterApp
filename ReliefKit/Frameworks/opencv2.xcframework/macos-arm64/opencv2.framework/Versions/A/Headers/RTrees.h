...
//
/**
 * - SeeAlso ``setCalculateVarImportance:``
 */
...
//
/**
 *  getCalculateVarImportance - SeeAlso ``getCalculateVarImportance:``
 */
...
//
/**
 *  getActiveVarCount - SeeAlso ``getActiveVarCount:``
 */
