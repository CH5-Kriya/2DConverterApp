...
typedef NS_ENUM(int, ImwriteBMPCompressionFlags) {
...
typedef NS_ENUM(int, ImwriteTiffResolutionUnitFlags) {
...
typedef NS_ENUM(int, ImwriteWEBPLosslessMode) {
 ...
 *
 * Member enums: `ImreadModes`, `ImwriteFlags`, `ImwriteJPEGSamplingFactorParams`, `ImwriteTiffCompressionFlags`, `ImwriteTiffPredictorFlags`, `ImwriteTiffResolutionUnitFlags`, `ImwriteEXRTypeFlags`, `ImwriteEXRCompressionFlags`, `ImwritePNGFlags`, `ImwritePNGFilterFlags`, `ImwritePAMFlags`, `ImwriteWEBPLosslessMode`, `ImwriteHDRCompressionFlags`, `ImwriteBMPCompressionFlags`, `ImwriteGIFCompressionFlags`, `ImageMetadataType`
 */
 ...
 *
 * - SeeAlso cv::haveImageWriter, cv::imread, cv::imdecode
 */
 ...
 *
 * - SeeAlso cv::haveImageReader, cv::imwrite, cv::imencode
 */
