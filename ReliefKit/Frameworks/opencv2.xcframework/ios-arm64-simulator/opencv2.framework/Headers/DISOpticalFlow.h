...
//
/**
 *  getFinestScale - SeeAlso ``getFinestScale:``
 */
 ...
 */
- (void)setCoarsestScale:(int)val NS_SWIFT_NAME(setCoarsestScale(val:));
 ...
 */
- (int)getCoarsestScale NS_SWIFT_NAME(getCoarsestScale());
...
//
/**
 *  getPatchSize - SeeAlso ``getPatchSize:``
 */
...
//
/**
 *  getPatchStride - SeeAlso ``getPatchStride:``
 */
 ...
 * - SeeAlso ``setGradientDescentIterations:``
 */
...
//
/**
 *  getGradientDescentIterations - SeeAlso ``getGradientDescentIterations:``
 */
 ...
 * - SeeAlso ``setVariationalRefinementAlpha:``
 */
...
//
/**
 *  getVariationalRefinementAlpha - SeeAlso ``getVariationalRefinementAlpha:``
 */
 ...
 * - SeeAlso ``setVariationalRefinementDelta:``
 */
...
//
/**
 *  getVariationalRefinementDelta - SeeAlso ``getVariationalRefinementDelta:``
 */
 ...
 * - SeeAlso ``setVariationalRefinementGamma:``
 */
...
//
/**
 *  getVariationalRefinementGamma - SeeAlso ``getVariationalRefinementGamma:``
 */
 ...
 * - SeeAlso ``setVariationalRefinementEpsilon:``
 */
...
//
/**
 *  getVariationalRefinementEpsilon - SeeAlso ``getVariationalRefinementEpsilon:``
 */
 ...
 *         in illumination.
 * - SeeAlso ``setUseMeanNormalization:``
 */
...
//
/**
 *  getUseMeanNormalization - SeeAlso ``getUseMeanNormalization:``
 */
 ...
 * - SeeAlso ``setUseSpatialPropagation:``
 */
...
//
/**
 *  getUseSpatialPropagation - SeeAlso ``getUseSpatialPropagation:``
 */
