...
//
/**
 *  getRangeMaxVal - SeeAlso ``getRangeMaxVal:``
 */
 ...
 * - SeeAlso ``setSaturationThreshold:``
 */
...
//
/**
 *  getSaturationThreshold - SeeAlso ``getSaturationThreshold:``
 */
...
//
/**
 *  getHistBinNum - SeeAlso ``getHistBinNum:``
 */
