 ...
 *     To create a new empty Delaunay subdivision you need to use the ``Subdiv2D/initDelaunay`` function.
 */
- (instancetype)init;
...
//
- (instancetype)initWithRect2f:(Rect2f*)rect2f;
 ...
 * @param rect Rectangle that includes all of the 2d points that are to be added to the subdivision.
 */
- (void)initDelaunay2f:(Rect2f*)rect NS_SWIFT_NAME(initDelaunay(rect:));
