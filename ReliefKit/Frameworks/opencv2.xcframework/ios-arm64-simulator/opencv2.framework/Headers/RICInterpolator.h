 ...
 *
 * - SeeAlso cv::ximgproc::createSuperpixelSLIC
 */
 ...
 * - SeeAlso ``setUseVariationalRefinement:``
 */
 ...
 * - SeeAlso ``setUseGlobalSmootherFilter:``
 */
